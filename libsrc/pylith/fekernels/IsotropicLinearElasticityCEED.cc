#include <ceed.h>
#include <portinfo>
#include "IsotropicLinearElasticityCEED.hh"
#include "pylith/fekernels/Elasticity.hh" // USES Elasticity kernels


void 
pylith::fekernels::IsotropicLinearElasticityCEED::CEED_integrate(int dim){
	...
	CeedQFunctionCreateInterior(ceed, 1, IsotropicLinearElasticityQFunction, __FILE__":IsotropicLinearElasticity", &qf_physics);
